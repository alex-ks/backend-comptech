...
namespace Comptech.Backend.Service.Test
{
    public class PhotoControllerTest
    {
        ...
        private PhotoController CreateControllerForGetPhotoTest(Session testSession, Photo testPhoto,
            RecognitionResults testRecognitionResults)
        {
            ...
            return new PhotoController(photoRepository, sessionRepository, recognitionResultsRepository,
                app.UserManager, new LoggerFactory())
            {
        ...
        [InlineData(true)]
        [InlineData(false)]
        public async void GetPhotoForWebTest(bool recognitionResultsArePresent)
        {
            ...
            PhotoController photoController =
                CreateControllerForGetPhotoTest(testSession, testPhoto, testRecognitionResults);

            var result = (await photoController.GetPhoto() as OkObjectResult).Value;

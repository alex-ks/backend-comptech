...
namespace Comptech.Backend.Data
{
    public class PsqlContext:DbContext
    {
        ...
        public static string DefaultConnection
            = @"User ID=comptech-backend;Password=c@N1h3lpy0u??;Host=84.237.52.125;Port=5432;Database=comptech-be;Pooling=true;";
        ...
        protected PsqlContext(DbContextOptions options) : base(options)
        {
        ...
        private void InitializeDbUser(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<DbUser>()
                .HasKey(u => u.UserId);//.ToTable("UspNetUsers");
